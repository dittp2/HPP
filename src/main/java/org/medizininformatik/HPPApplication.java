	...
	public void run(String... args) throws Exception { }
		...
		CommandLineRunner runner(HPDirectory hpDirectory) {
			...
			return args -> {				
				...
				userRepository.save(new User("","Bruno", "","Hugentobler", 1, new Date(75,9,03)));
				userRepository.save(new User("", "Astrid","Simone", "Beieler", 1,new Date(18,06,14)));
				userRepository.save(new User("Dr.", "Markus","Peter", "Meister", 2, new Date(18,06,14)));
				userRepository.save(new User("Herr", "Pietro","Pablo", "Golums", 2, new Date(72,06,14)));
				userRepository.save(new User("Dr.", "Susanne","Nadia", "Rössner", 1,new Date(18,06,14)));
				...
				hpDirectory.save(new HealthProfessional("124687122" , "Zimmermann", "Markus", "Phys.", "männlich"));
				...
				hpDirectory.save(new HealthProfessional("123456765432" , "Zurkinden", "Erni", "Dr. med.", "Doctor","m'nnlih "," "," "," "," "," "," "," "));
